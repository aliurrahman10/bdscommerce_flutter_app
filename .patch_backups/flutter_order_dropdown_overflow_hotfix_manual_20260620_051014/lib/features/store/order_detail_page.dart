...
class _StatusCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final dropdownItemWidth = (MediaQuery.of(context).size.width - 96).clamp(180.0, 420.0).toDouble();
    return Card(
      child: Padding(
        padding: const EdgeInsets.all(16),
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              return DropdownMenuItem<int>(
                ...
                child: SizedBox(
                  ...
                  child: Row(children: [
                    ...
                    Expanded(child: Text(s['name'].toString(), maxLines: 1, overflow: TextOverflow.ellipsis)),
                  ]),
                ),
              );
            }).toList(),
