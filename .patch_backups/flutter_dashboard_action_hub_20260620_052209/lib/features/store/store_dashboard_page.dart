          ...
          child: ListView(
            ...
            children: [
              ...
              GridView.count(
                ...
                mainAxisSpacing: 12,
                children: [
                  PremiumMetricCard(title: t('Orders', 'অর্ডার'), value: summary['total_orders'] ?? 0, icon: Icons.shopping_bag_rounded, gradient: AppTheme.premiumGradient, caption: t('Total orders', 'মোট অর্ডার')),
                  PremiumMetricCard(title: t('Today', 'আজ'), value: summary['today_orders'] ?? 0, icon: Icons.today_rounded, gradient: AppTheme.infoGradient, caption: t('Today activity', 'আজকের কার্যক্রম')),
                  PremiumMetricCard(title: t('Pending', 'পেন্ডিং'), value: summary['pending_orders'] ?? 0, icon: Icons.pending_actions_rounded, gradient: AppTheme.warningGradient, caption: t('Action needed', 'অ্যাকশন দরকার')),
                  PremiumMetricCard(title: t('Sales', 'সেলস'), value: '৳ ${summary['today_sales'] ?? 0}', icon: Icons.payments_rounded, gradient: AppTheme.successGradient, caption: t('Today revenue', 'আজকের আয়')),
                ],
              ),
