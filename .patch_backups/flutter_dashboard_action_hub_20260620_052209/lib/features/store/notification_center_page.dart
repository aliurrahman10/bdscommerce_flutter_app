...
class _MetricGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final items = [
      _MetricItem('Pending', summary['pending_orders'] ?? 0, Icons.pending_actions_outlined, AppTheme.warningGradient),
      _MetricItem('Unread Push', summary['unread_push_logs'] ?? 0, Icons.mark_email_unread_outlined, AppTheme.infoGradient),
      _MetricItem('Failed Push', summary['failed_push_logs'] ?? 0, Icons.error_outline, AppTheme.dangerGradient),
      _MetricItem('Activity', summary['recent_activity'] ?? 0, Icons.history_outlined, AppTheme.successGradient),
    ];
...
class _MetricItem {
  const _MetricItem(this.title, this.value, this.icon, this.gradient);
  final String title;
  final Object value;
  final IconData icon;
